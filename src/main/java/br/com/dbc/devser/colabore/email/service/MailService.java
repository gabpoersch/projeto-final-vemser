...
public class MailService {
    ...
    public void fundraiserMailService(FundraiserEntity fundraiserEntity) throws Exception {
    ...
    public void donatorMailService(DonationEntity donationEntity, FundraiserEntity fundraiserEntity) throws Exception {
